...
const TechSupportMain = () => {
    ...
    const columes = [
        ...
        },
        {
            ...
            key:'addresProp',
            render:({cityOrVillage,region,apartmentNumber,street}:any)=>  (cityOrVillage !== " " ? <div>{region} ,{cityOrVillage}, ул. {street} {apartmentNumber}</div> :<div>-</div>)
        },
        {
        ...
        },
        {
            ...
            key:'passport',
            render:({authority,dateOfIssue,tin}:any)=>  (authority !== " " ? <div>{authority} {dateOfIssue} {tin} </div> :<div>-</div>)
        },
        {
            title:'',
            dataIndex:'id',
            key:'id',
            render:(_:any,datail:any)=> <Link 
    ...
    return (
        ...
        >
          <div className="content">
            ...
            <Table columns={columes} dataSource={data} loading={{ indicator: <Spinner color='blue' />,spinning:isLoading}}/>
          </div>  
